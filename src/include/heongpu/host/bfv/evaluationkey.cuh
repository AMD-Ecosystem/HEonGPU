...
#ifndef HEONGPU_BFV_EVALUATIONKEY_H
#define HEONGPU_BFV_EVALUATIONKEY_H
...
namespace heongpu
{
     ...
     */
    template <>
    class MultipartyRelinkey<Scheme::BFV> : public Relinkey<Scheme::BFV>
    {
        template <Scheme S> friend class HEKeyGenerator;
        template <typename T, typename F>
        friend void input_storage_manager(T& object, F function,
      ...
      public:
        __host__ MultipartyRelinkey(HEContext<Scheme::BFV> context,
                                    const RNGSeed seed);
     ...
     */
    template <>
    class MultipartyGaloiskey<Scheme::BFV> : public Galoiskey<Scheme::BFV>
    {
        template <Scheme S> friend class HEKeyGenerator;

      public:
        __host__ MultipartyGaloiskey(HEContext<Scheme::BFV> context,
                                     const RNGSeed seed);
